...
SUPERVISORES_DICT = {k.upper(): v for k, v in {
    "ARIZA MARIN SERGIO": "ANDRES ARROYAVE", "ANDRES ARROYAVE": "ANDRES ARROYAVE", "ANDRES ARROYAVE": "ANDRES ARROYAVE",
...
st.markdown("""
    ...
    /* =========================================
       DISEÑO LIMPIO Y OPERATIVO (RESTAURADO)
       ========================================= */
    .block-container {
    ...
    /* Estilos para el contenedor de metadata */
    .meta-container {
        display: flex;
        gap: 30px;
        padding: 5px 15px;
...
if st.session_state.usuario is None:
    ...
    st.markdown(f"""
        ...
        .circle-logo {{
            position: absolute;
            left: 50%;
            top: 70px; /* Movido mucho más arriba */
